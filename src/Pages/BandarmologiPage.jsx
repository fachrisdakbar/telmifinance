...
// // Helper: ubah string angka ke number aman
...
// // Urutkan dari Total Value terbesar ke kecil
// const rankCompare = (a, b) => b.totalValue - a.totalValue;

// // Cek apakah broker match query (kode atau nama). Mendukung banyak token dipisah spasi/koma.
...
//   useEffect(() => {
//     Papa.parse("/src/assets/allbrokertrx.csv", {
//       download: true,
//       skipEmptyLines: true,           // skip baris kosong dari CSV
//       complete: (result) => {
//         const rows = result.data;

//         // Jika file ada header: ambil mulai index 1, kalau tidak ada header bisa sesuaikan
...
//         }))
//         // buang baris yang tak valid
//         .filter(b => b.code && b.brokerName && (b.totalBuy || b.totalSell || b.totalValue));

//         // rank awal by totalValue desc
//         data.sort(rankCompare);
...
//   // Submit pencarian (by kode ATAU nama)
//   const onSubmit = (e) => {
//     e.preventDefault();
//     if (!query.trim()) {
//       setFiltered([...brokers]); // reset
//       setCurrentPage(1);
//       return;
//     }
...
//   // Sort kolom (kode/nama/buy/sell/value)
...
//           Bandarmologi Brokers — Rankings by Total Value(K)
//         </h1>
...
//             />
//             <button type="submit" className="w-full px-6 py-2 mt-4 text-white bg-green-600 rounded-md">
//               Search
//             </button>
//           </form>
//         </div>
...
//               <tr>
//                 {/* Kolom nomor urut TIDAK memicu sort */}
...
//                   <td className="px-6 py-4 text-sm">{b.totalBuy.toLocaleString()}</td>
//                   <td className="px-6 py-4 text-sm">{b.totalSell.toLocaleString()}</td>
//                   <td className="px-6 py-4 text-sm">{b.totalValue.toLocaleString()}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
...
const BandarmologiPage = () => {
  ...
  useEffect(() => {
  Papa.parse("/src/assets/broksum.csv", {
    download: true,
    skipEmptyLines: true,
    complete: (result) => {
